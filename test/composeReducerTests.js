...
describe('composeReducers', () => {
  ...
  it("returns a reducer that applies all arguments", () => {
    ...
    expect(reducer(undefined, {type: 'action0', payload: 'test'})).to.deep.equal({field0: 'test'})
    expect(reducer(undefined, {type: 'action1', payload: 'test2'})).to.deep.equal({field0: 'test2', field1: 'test2'})
  })
